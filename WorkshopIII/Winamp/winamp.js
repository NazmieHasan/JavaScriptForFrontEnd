function renderDataInHTML() {
    ...
    let image=$('<img src="music.png" alt="music">');
    ...
    let prevIcon=$('<i id="prev" class="fa fa-step-backward" aria-hidden="true"></i>');
    prevIcon.appendTo(divContainer);

    let playIcon=$('<i id="play" class="fa fa-play-circle" aria-hidden="true"></i>');
    ...
    let nextIcon=$('<i id="next" class="fa fa-step-forward" aria-hidden="true"></i>');
